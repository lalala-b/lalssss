<template>
  <Wrap class="">
    <!-- 搜索层 -->
    <Search ref="Search" :query-data="queryData" :xingtu-tag-data="xingtuTagData" tip="统计时间段内按照点赞增量排序" @getData="getBillBoardData" @reset="resetListData" @clear="clear" />
    <!-- 无限list -->
    <ScrollList ref="List" :data="data" style="margin-top: 20px;" type="like" @getData="getBillBoardData" />
    <!-- 回到顶部 -->
    <BackToTop />
  </Wrap>
</template>
